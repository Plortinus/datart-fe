 ...
 */
import { BoardInitProvider } from '@/pages/DashBoardPage/components/BoardProvider/BoardInitProvider';
import { FullScreenPanel } from '@/pages/DashBoardPage/components/FullScreenPanel/FullScreenPanel';
import { AutoBoardCore } from '@/pages/DashBoardPage/pages/Board/AutoDashboard/AutoBoardCore';
import { FreeBoardCore } from '@/pages/DashBoardPage/pages/Board/FreeDashboard/FreeBoardCore';
import { makeSelectBoardConfigById } from '@/pages/DashBoardPage/pages/Board/slice/selector';
