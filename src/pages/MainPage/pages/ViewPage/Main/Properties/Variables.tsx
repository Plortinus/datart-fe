...
import { getRoles } from '@/pages/MainPage/pages/MemberPage/slice/thunks';
import { SubjectForm } from '@/pages/MainPage/pages/VariablePage/SubjectForm';
import { VariableForm } from '@/pages/MainPage/pages/VariablePage/VariableForm';
import {
  VariableScopes,
  VariableTypes,
  VariableValueTypes,
} from '@/pages/MainPage/pages/VariablePage/constants';
import {
  RowPermission,
  Variable,
} from '@/pages/MainPage/pages/VariablePage/slice/types';
import { VariableFormModel } from '@/pages/MainPage/pages/VariablePage/types';
