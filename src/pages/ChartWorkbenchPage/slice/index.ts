...
import { migrateViewConfig } from '@/migration/ViewConfig/migrationViewDetailConfig';
...
import { transformHierarchyMeta } from '@/utils/internalChartHelper';
import { updateCollectionByAction } from '@/utils/mutation';
