...
import { DownloadListPopup } from '@/pages/MainPage/Navbar/DownloadListPopup';
import { loadTasks } from '@/pages/MainPage/Navbar/service';
import { selectHasVizFetched } from '@/pages/MainPage/pages/VizPage/slice/selectors';
import { getFolders } from '@/pages/MainPage/pages/VizPage/slice/thunks';
import {
  FONT_SIZE_ICON_SM,
  FONT_WEIGHT_MEDIUM,
  LINE_HEIGHT_ICON_SM,
