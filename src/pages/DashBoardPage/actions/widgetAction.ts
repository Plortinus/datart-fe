...
import { tablePagingAndSortEventListener } from '@/utils/ChartEventListenerHelper';
import {
...
import { ORIGINAL_TYPE_MAP, jumpTypes } from '../constants';
...
export const widgetGetDataAction =
  (editing: boolean, widget: Widget, renderMode: VizRenderMode) =>
  (dispatch) => {
