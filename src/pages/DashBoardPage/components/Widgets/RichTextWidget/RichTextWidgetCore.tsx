...
import {
  CustomColor,
  QuillPalette,
} from '@/components/ChartGraph/BasicRichText/RichTextPluginLoader/CustomColor';
import useI18NPrefix from '@/hooks/useI18NPrefix';
import { WidgetInfo } from '@/pages/DashBoardPage/pages/Board/slice/types';
import { editBoardStackActions } from '@/pages/DashBoardPage/pages/BoardEditor/slice';
