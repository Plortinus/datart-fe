 ...
 */
import WidgetOfFree from '@/pages/DashBoardPage/pages/Board/FreeDashboard/WidgetOfFree';
import WidgetOfFreeEdit from '@/pages/DashBoardPage/pages/BoardEditor/FreeEditor/WidgetOfFreeEdit';
