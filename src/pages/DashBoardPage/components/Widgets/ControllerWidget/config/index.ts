...
import { RelatedWidgetItem } from '@/pages/DashBoardPage/pages/BoardEditor/components/ControllerWidgetPanel/RelatedWidgets';
import { ControllerConfig } from '@/pages/DashBoardPage/pages/BoardEditor/components/ControllerWidgetPanel/types';
import {
  Widget,
...
import { transformToViewConfig } from '@/utils/internalChartHelper';
