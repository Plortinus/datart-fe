...
import { ChartDataViewFieldCategory, DataViewFieldType } from '@/constants';
...
} from '@/pages/DashBoardPage/components/Widgets/ControllerWidget/config';
import { selectViewMap } from '@/pages/DashBoardPage/pages/Board/slice/selector';
import {
