 ...
 */
import { migrateBoardConfig } from '@/migration/BoardConfig/migrateBoardConfig';
import migrateChartConfig from '@/migration/ChartConfig/migrateChartConfig';
