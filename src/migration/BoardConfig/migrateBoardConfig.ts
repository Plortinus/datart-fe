 ...
 */
import { MIN_MARGIN, MIN_PADDING } from '@/pages/DashBoardPage/constants';
import { BoardTypes } from '@/pages/DashBoardPage/pages/Board/slice/types';
import { BoardConfig } from '@/pages/DashBoardPage/types/boardTypes';
import {
  getInitBoardConfig,
