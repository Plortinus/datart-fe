...
import { OperatorTypes } from '@/components/FormGenerator/Customize/ConditionalStyle/types';
import { ScorecardConditionalStyleFormValues } from '@/components/FormGenerator/Customize/ScorecardConditionalStyle/types';
