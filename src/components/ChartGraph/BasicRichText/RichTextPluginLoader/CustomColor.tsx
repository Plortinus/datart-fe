import { defaultPalette, defaultThemes } from '@/assets/theme/colorsConfig';
import ChromeColorPicker from '@/components/ColorPicker/ChromeColorPicker';
 ...
 * 实际配置方式可参考 src/@/components/ChartGraph/BasicRichText/ChartRichTextAdapter.tsx
 */
