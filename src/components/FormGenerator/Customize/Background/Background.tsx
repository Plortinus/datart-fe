...
import { BackgroundConfig } from '@/pages/DashBoardPage/pages/Board/slice/types';
import { UploadDragger } from '@/pages/DashBoardPage/pages/BoardEditor/components/SlideSetting/SettingItem/BasicSet/ImageUpload';
